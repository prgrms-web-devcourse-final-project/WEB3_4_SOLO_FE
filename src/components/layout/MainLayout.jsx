...
const MainLayout = ({ children }) => {
  ...
  const isAdmin = useMemo(() => {
    ...
    // 이메일로 관리자 확인 (개발용)
    if (user.email === 'admin@pleasybank.com') {
      return true;
    }
  ...
  const navigation = [
    ...
    { name: '금융상품 몰', href: '/products', icon: ProductIcon, requiresAuth: true },
  ...
  const publicNavigation = [
    { name: '금융상품 몰', href: '/products', icon: ProductIcon, requiresAuth: false },
